...
MODULES=(
    ...
    "07_antigravity_ide.sh"
    "08_onlyoffice_padrao.sh"
    "09_cosmic_music_applet.sh"
    "10_mouse_gaming.sh"
    "11_wacom_tablet.sh"
    "12_kando_restore.sh"
    "13_cosmic_restore.sh"
    "14_ide_config_restore.sh"
    "15_zsh_p10k_setup.sh"
    "16_jogos_performance.sh"
    "17_flatpak_permissions.sh"
    "18_manutencao_ssds.sh"
    "19_autostart_config.sh"
    "20_limpeza_otimizacao.sh"
)
