...
MODULES=(
    ...
    "10_mouse_gaming.sh"
    "11_kando_restore.sh"
    "12_cosmic_restore.sh"
    "13_ide_config_restore.sh"
    "14_zsh_p10k_setup.sh"
    "15_jogos_performance.sh"
    "16_flatpak_permissions.sh"
    "17_manutencao_ssds.sh"
    "18_autostart_config.sh"
    "19_limpeza_otimizacao.sh"
)
